...
def IIRuncFilter(x, Ux, b, a, Uab, state = None, kind="diag"):
    ...
    ----------
        ...
        state: dict
            ...
            If not given, internal state is assumed to be zero. If given, the input parameters (b, a, Uab)
            are ignored to avoid repetitive rebuild of the internal system description. However a valid new
            state (i.e. with new b, a, Uab) can always be generated by using :py:func:`get_initial_state()`.
